        ...
        <div style="width: 100%; max-width: 500px; background-color: #fdfdfd; padding: 30px; border-radius: 10px; border: 1px solid #ddd;">
            ...
            <form action="{{ route('albums.store') }}" method="POST">
                ...
                <div style="text-align: center;">
                    <button type="submit" style="padding: 8px 16px; font-size: 14px; background-color: #ccc; border: 1px solid #999; border-radius: 3px; cursor: pointer;">Tambah Album</button>
                </div>
            </form>
        </div>
    </div>
