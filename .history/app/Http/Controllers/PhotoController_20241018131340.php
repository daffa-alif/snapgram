...
class PhotoController extends Controller
{
    ...
    public function index(Album $album)
    {
        ...
        return view('photos.create', compact('album', 'photos')); // Change to appropriate view for displaying photos
    }
    ...
    public function create()
    {
        ...
        // Pass the albums variable to the view
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'photo' => 'required|image|max:2048', // Corrected to 'photo' to match the form field name
        ]);
